          ...
          <div className="bg-card border border-border rounded-lg p-8">
            ...
            <form className="space-y-6">
              ...
              <div>
                ...
                <select className="w-full px-4 py-3 bg-input border border-border rounded-md text-foreground focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent">
